...
pub const SITE_SEED_EDITOR: &str = r##"{"selectedComponentId":"test-c-0","active":"/home","editorEvents":{},"debugBounding":false,"buildSubmenu":"file","componentTab":{"type":"style"},"mode":"selC","showComponentTree":true,"componentTreeExpandedItems":{"test-c-0":true,"test-c-1":true,"test-c-2":true},"selectedThemeColors":[],"builderWidth":1080,"builderScale":0.81,"cssPseudoClass":"default"}"##;
