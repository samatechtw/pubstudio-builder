...
pub const SITE_SEED_EDITOR: &str = r##"{"selectedComponentId":"init-c-8","active":"/home","buildSubmenu":"file","themeTab":"variables","componentTab":{},"mode":"selC","showComponentTree":true,"componentTreeExpandedItems":{"init-c-0":true,"init-c-1":true,"init-c-4":true,"init-c-8":true,"init-c-51":true,"init-c-53":true,"init-c-52":true},"componentTreeRenameData":{"renaming":false},"componentsHidden":{},"selectedThemeColors":[],"builderWidth":1080,"builderScale":0.81,"cssPseudoClass":"default","hotkeys":{},"prefs":{},"templatesShown":false,"componentMenuCollapses":{"dimensions":false,"styles":false,"childStyles":false}}"##;
