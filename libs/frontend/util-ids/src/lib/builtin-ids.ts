...
export const videoStyleId = styleId(globalContext.namespace, 'video')
export const videoWrapStyleId = styleId(globalContext.namespace, 'videowrap')
export const videoId = componentId(globalContext.namespace, 'video')
export const videoWrapId = componentId(globalContext.namespace, 'videowrap')
export const videoSourceId = componentId(globalContext.namespace, 'videosource')
